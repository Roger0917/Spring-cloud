...
public class InformationReportController {
	...
	public void checkAccount() throws Exception{
		...
		sb.append("<Cash_Cst_AccNo><![CDATA[51050164860300000409]]></Cash_Cst_AccNo>");	//现金客户账户
		...
		sb.append("<CCstTr_ID><![CDATA[CMN0003101857]]></CCstTr_ID>");
	...
	public void checkAccountHis() throws Exception{
		...
		sb.append("<Rvl_Rcrd_Num><![CDATA[3]]></Rvl_Rcrd_Num>");	//循环记录条数
		sb.append("<LIST1 type='G'>");
		sb.append("<AccNo><![CDATA["+Const.AccNo+"]]></AccNo>"); //账号
		sb.append("<CCstTr_ID><![CDATA["+Const.CCstTr_ID+"]]></CCstTr_ID>"); //现金客户树编号
		sb.append("<CCstTrNdID><![CDATA["+Const.CCstTrNdID+"]]></CCstTrNdID>"); //现金客户树节点编号
		sb.append("</LIST1>");
	...
	public void checkAccDet() throws Exception{
		...
		sb.append("</LIST1>");
		sb.append("<StDt><![CDATA[20181101]]></StDt>"); //开始日期
		sb.append("<EdDt><![CDATA[20181115]]></EdDt>"); //结束日期
		...
		sb.append("<Enqr_Dtl_TpCd><![CDATA[]]></Enqr_Dtl_TpCd>"); //查询明细类型代码
